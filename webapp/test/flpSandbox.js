		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Learning SAP",
									"targetURL": "#myfirstsapapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"myfirstsapapp-display": {
								"semanticObject": "myfirstsapapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=myfirstsapapp",
									"url": sap.ui.require.toUrl("myfirstsapapp")
								}
							}
						}
					}
